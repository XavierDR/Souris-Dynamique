...
NUITKA_LOCAL_MODULE PyObject *impl_function_3_get_callable_name_desc_of___internal__( PyObject *_python_par_called );
...
NUITKA_CROSS_MODULE PyObject *impl_function_8_complex_call_helper_pos_star_list_of___internal__( PyObject *_python_par_called, PyObject *_python_par_args, PyObject *_python_par_star_arg_list );
...
NUITKA_CROSS_MODULE PyObject *impl_function_10_complex_call_helper_keywords_star_list_of___internal__( PyObject *_python_par_called, PyObject *_python_par_kw, PyObject *_python_par_star_arg_list );
...
NUITKA_CROSS_MODULE PyObject *impl_function_2_complex_call_helper_star_list_of___internal__( PyObject *_python_par_called, PyObject *_python_par_star_arg_list )
{
    ...
    PyObject *par_star_arg_list = _python_par_star_arg_list;
    ...
    // Tried code:
    tmp_isinstance_inst_1 = par_star_arg_list;
    ...
    if ( tmp_tuple_arg_1 == NULL )
    {
        ...
        exception_value = UNSTREAM_STRING( &constant_bin[ 15436 ], 59, 0 );
        exception_tb = NULL;
    ...
    tmp_tuple_element_1 = impl_function_3_get_callable_name_desc_of___internal__( tmp_dircall_arg1_1 );
...
NUITKA_CROSS_MODULE PyObject *impl_function_4_complex_call_helper_pos_keywords_star_dict_of___internal__( PyObject *_python_par_called, PyObject *_python_par_args, PyObject *_python_par_kw, PyObject *_python_par_star_arg_dict )
{
    ...
    if ( tmp_source_name_1 == NULL )
    {
        ...
        exception_type = PyExc_UnboundLocalError;
        Py_INCREF( exception_type );
        exception_value = UNSTREAM_STRING( &constant_bin[ 15495 ], 59, 0 );
        exception_tb = NULL;
        NORMALIZE_EXCEPTION( &exception_type, &exception_value, &exception_tb );
        CHAIN_EXCEPTION( exception_value );
    ...
    tmp_compare_left_2 = tmp_dict_1__key_xxx;

    tmp_compare_right_2 = par_kw;
    ...
    if ( tmp_dircall_arg1_2 == NULL )
    {
        ...
        exception_type = PyExc_UnboundLocalError;
        Py_INCREF( exception_type );
        exception_value = UNSTREAM_STRING( &constant_bin[ 15554 ], 52, 0 );
        exception_tb = NULL;
        NORMALIZE_EXCEPTION( &exception_type, &exception_value, &exception_tb );
        CHAIN_EXCEPTION( exception_value );
    ...
    tmp_tuple_element_2 = impl_function_3_get_callable_name_desc_of___internal__( tmp_dircall_arg1_2 );
    ...
    tmp_compare_left_3 = tmp_dict_2__key;
    ...
    tmp_tuple_element_3 = impl_function_3_get_callable_name_desc_of___internal__( tmp_dircall_arg1_3 );
    ...
    goto try_return_handler_1;
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE( function_4_complex_call_helper_pos_keywords_star_dict_of___internal__ );
    return NULL;
    // Return handler code:
    try_return_handler_1:;
    Py_XDECREF( par_called );
...
NUITKA_CROSS_MODULE PyObject *impl_function_7_complex_call_helper_pos_star_list_star_dict_of___internal__( PyObject *_python_par_called, PyObject *_python_par_args, PyObject *_python_par_star_arg_list, PyObject *_python_par_star_arg_dict )
{
    ...
    tmp_isinstance_inst_2 = par_star_arg_list;
...
NUITKA_CROSS_MODULE PyObject *impl_function_8_complex_call_helper_pos_star_list_of___internal__( PyObject *_python_par_called, PyObject *_python_par_args, PyObject *_python_par_star_arg_list )
{
    ...
    goto try_return_handler_1;
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE( function_8_complex_call_helper_pos_star_list_of___internal__ );
    return NULL;
    // Return handler code:
    try_return_handler_1:;
    Py_XDECREF( par_called );
...
NUITKA_CROSS_MODULE PyObject *impl_function_9_complex_call_helper_keywords_star_dict_of___internal__( PyObject *_python_par_called, PyObject *_python_par_kw, PyObject *_python_par_star_arg_dict )
{
    ...
    goto try_return_handler_1;
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE( function_9_complex_call_helper_keywords_star_dict_of___internal__ );
    return NULL;
    // Return handler code:
    try_return_handler_1:;
    Py_XDECREF( par_called );
...
NUITKA_CROSS_MODULE PyObject *impl_function_10_complex_call_helper_keywords_star_list_of___internal__( PyObject *_python_par_called, PyObject *_python_par_kw, PyObject *_python_par_star_arg_list )
{
    ...
    goto try_return_handler_1;
    // tried codes exits in all cases
    NUITKA_CANNOT_GET_HERE( function_10_complex_call_helper_keywords_star_list_of___internal__ );
    return NULL;
    // Return handler code:
    try_return_handler_1:;
    Py_XDECREF( par_called );
